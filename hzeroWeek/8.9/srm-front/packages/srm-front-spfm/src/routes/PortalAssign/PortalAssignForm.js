  ...
  renderForm() {
    ...
    return (
      <React.Fragment>
        ...
        {/* {isEmpty(initData) &&
          (
            <FormItem {...formItemLayout} label={intl.get('hmsg.portalTemplate.model.portalTemplate.templateName').d('模板名称')}>
              {getFieldDecorator('templateId', {
                rules: [
                  {
                    required: true,
                    message: intl.get('hzero.common.validation.notNull', {
                      name: intl.get('hmsg.portalTemplate.model.portalTemplate.templateName').d('模板名称'),
                    }),
                  },
                ],
              })(
